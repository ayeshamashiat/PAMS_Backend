...
const fileFilter = (req, file, cb) => {
  if (file.mimetype === "text/csv" || file.originalname.endsWith(".csv")) {
    ...
    cb(new Error("Only CSV files are allowed for faculty upload"), false);
  }
};

// Multer instance with limits
const uploadFacultyCSV = multer({
  storage,
  fileFilter,
  limits: {
...
module.exports = uploadFacultyCSV;
